...
dotenv.config();
const client = new OpenAI({ baseURL: 'https://api.naga.ac/v1', apiKey: process.env.API_KEY });
...
const systemPrompt = "You are a helpful assistant with web result search capabilities.";
